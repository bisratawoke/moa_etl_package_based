...
function syncWithOutGeom() {
    return __awaiter(this, void 0, void 0, function () {
        var pool, client, cursor, numOrRow, rows, x, record;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pool = new Pool({
                ...
                case 5:
                    ...
                    record = __assign(__assign({}, rows[x]), { area: Number(rows[x]["areageom"]) });
                    return [4 /*yield*/, (0, extract_1.insertIntoElastic)("nrlais_parcel_without_geom", record, record["parcel_id"])];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
